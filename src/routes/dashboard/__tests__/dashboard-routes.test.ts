...
const {
  ...
  mockRunBackup,
  mockGetDataPointDefaultsWithCategory, mockGetDataPointDefault,
  mockUpdateDataPointDefault, mockCreateDataPointDefault, mockDeleteDataPointDefault,
  mockReorderDataPointDefaults, mockCountDataPointsInCategory, mockListUsedCategories,
  ...
  mockGetDataPointDefault: vi.fn(),
  mockCountDataPointsInCategory: vi.fn(),
  mockListUsedCategories: vi.fn(),
...
vi.mock("../../../lib/data-point-defaults.js", () => ({
  ...
  getDataPointDefault: (...a: any[]) => mockGetDataPointDefault(...a),
  ...
  countDataPointsInCategory: (...a: any[]) => mockCountDataPointsInCategory(...a),
  listUsedCategories: (...a: any[]) => mockListUsedCategories(...a),
  CATEGORY_ORDER: ["A", "B"],
