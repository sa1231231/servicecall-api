...
export interface NotificationPayload {
  ...
  visibleFields: Array<{ label: string; value: string }>;
  smsMessage: string;
  emailBody: string;
  emailHtml: string;
  emailSubject: string;
...
export type BuildResult =
  ...
  | { ok: false; reason: "no_message_type" | "failed_required" | "empty_call"; details: string };
...
export function buildNotificationMessages(input: BuildNotificationInput): BuildResult {
