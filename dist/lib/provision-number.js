...
export async function provisionPhoneNumber(options) {
    ...
    if (terminationUri) {
        ...
        if (!authUsername || !authPassword) {
            console.warn(`[provision] warning: RETELL_SIP_TRUNK_AUTH_USERNAME/PASSWORD not set — warm transfer through BYOC trunk will not work for ${targetNumber} until credentials are added in Retell's dashboard.`);
        }
