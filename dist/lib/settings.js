...
export async function updateSettings(updates) {
    ...
    if (updates.stripe_payment_url !== undefined)
        setObj.stripe_payment_url = updates.stripe_payment_url;
    if (updates.payment_sms_message !== undefined)
        setObj.payment_sms_message = updates.payment_sms_message;
    if (updates.portal_sms_message !== undefined)
        setObj.portal_sms_message = updates.portal_sms_message;
    if (updates.free_trial_days !== undefined)
        setObj.free_trial_days = updates.free_trial_days;
