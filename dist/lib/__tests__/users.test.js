...
import { hashPassword, verifyPassword, resolvePermissions, PERMISSION_KEYS, PERMISSION_DEFS, DEFAULT_PERMISSIONS, } from "../users.js";
...
describe("createUser", () => {
    it("creates user with default permissions for role", async () => {
        ...
        expect(mockDbInsertOne).toHaveBeenCalledWith(expect.objectContaining({
            _id: "newuser",
            role: "operator",
