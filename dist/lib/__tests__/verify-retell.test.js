...
describe("verifyRetellWebhookOrThrow", () => {
    it("throws when signature is empty", () => {
        expect(() => verifyRetellWebhookOrThrow("body", "", "key")).toThrow("Missing x-retell-signature header");
    });
    it("throws when signatureKey is empty", () => {
        expect(() => verifyRetellWebhookOrThrow("body", "sig", "")).toThrow("Missing RETELL_SIGNATURE_KEY");
    });
    it("throws 'Invalid Retell signature' when SDK returns false", () => {
        mockVerify.mockReturnValue(false);
        expect(() => verifyRetellWebhookOrThrow("body", "sig", "key")).toThrow("Invalid Retell signature");
