...
// ── Main Function ────────────────────────────────────────────────────────────
export async function createAgentFromConfig(body) {
    // ── Validate ───────────────────────────────────────────────────────────────
    ...
    try {
        ...
        const humanMode = body.business.human_request_mode || "callback";
        const anyTransferPath = hasPaths && body.paths.some((p) => p.end_mode === "transfer");
        const warmTransferAgentVersion = humanMode === "live_transfer" || anyTransferPath
