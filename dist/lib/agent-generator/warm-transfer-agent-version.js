...
export async function getWarmTransferAgentVersion(retell) {
    const now = Date.now();
    ...
    try {
        ...
        console.warn(`[warm-transfer-agent-version] failed to fetch latest version of ${WARM_TRANSFER_AGENT_ID}, falling back to ${WARM_TRANSFER_AGENT_VERSION_FALLBACK}:`, err instanceof Error ? err.message : err);
    }
