...
export const DATA_POINT_REGISTRY = {
    full_name: {
        label: "Full Name",
        ...
        finetuneExamples: [
            {
                ...
                transcript: [
                    ...
                    {
                        content: "I'm sorry, I don't think I heard the complete phone number. Could you repeat all ten digits for me?",
                        role: "agent",
                    },
                ],
            },
...
##
Do not ask for any other information than what is instructed for this node.`,
        forwardCondition: "The caller has agreed to one of your day and time slot options, or has indicated they don't know when works.",
        finetuneExamples: [
            {
                type: "positive",
                transcript: [
            ...
            },
            {
                ...
                transcript: [
                    {
                        content: "Can you do Thursday morning, like between 8 and 10?",
                        role: "agent",
                    },
            ...
            },
            {
                ...
                transcript: [
                    {
                        content: "The earliest we can get someone out is between 12 and 2 today. Does that work?",
                        role: "agent",
                    },
            ...
            },
            {
                ...
                transcript: [
                    ...
                    {
                        content: "Sure. Is there a day that works best — like Tuesday, Wednesday, or Thursday?",
                        role: "agent",
                    },
                ],
            },
            ...
            },
            {
                ...
                transcript: [
                    ...
                    {
                        content: "We have openings tomorrow between 8 and 10, 10 and 12, or 12 and 2. Do any of those work?",
                        role: "agent",
                    },
                ],
            },
            {
                ...
                transcript: [
                    ...
                    {
                        content: "Let me check. The earliest we could get someone out today would be between 4 and 6. Would that work?",
                        role: "agent",
                    },
                ],
            },
