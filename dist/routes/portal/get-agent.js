    ...
    try {
        ...
        for (const [key, override] of Object.entries(dbt)) {
            ...
            if (override.dispatch_text_numbers?.length) {
                o.dispatch_text_numbers = override.dispatch_text_numbers.filter((n) => n !== ownerConfig.phone);
            }
            if (override.dispatch_email?.length) {
                o.dispatch_email = override.dispatch_email.filter((e) => e !== ownerConfig.email);
            }
