...
export async function createAppointmentHandler(req, res) {
    ...
    try {
        ...
        const start_iso = collectedVars?.matched_time_slot ?? dynamicVars?.matched_time_slot;
        const physical_address = collectedVars?.physical_address ?? dynamicVars?.physical_address ?? "";
        const contact_id = collectedVars?.contact_id ??
