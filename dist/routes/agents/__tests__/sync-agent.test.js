...
const { mockFlowCreate, mockFlowDelete, mockAgentCreate, mockNotificationClients, mockPersistClient, mockGetClientDocument, mockDeriveNotificationConfig, mockFetchRetellAgent, mockExtractFlowParams, mockExtractAgentParams, mockGenerateSlug, } = vi.hoisted(() => ({
...
vi.mock("../../../lib/slug.js", () => ({
    generateSlug: (...a) => mockGenerateSlug(...a),
}));
const { importAgentHandler, syncAgentHandler, duplicateAgentHandler } = await import("../sync-agent.js");
function makeRes() {
